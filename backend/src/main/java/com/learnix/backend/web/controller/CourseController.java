...
public class CourseController {
    ...
    public ResponseEntity<Page<DisplayCourseDto>> findAll(
            @ParameterObject Pageable pageable,
            @Parameter(description = "Optional category id to filter courses")
            @RequestParam(required = false) Long categoryId
    ) {
        return ResponseEntity.ok(courseApplicationService.findAll(pageable, categoryId));
    }
